...
## Meeting history
{Very succinct. Link to the `Knowledge/raw/` capture or `daily/` note rather than re-typing content.}
...
• Person notes are the SINGLE SOURCE OF TRUTH for per-person detail. Knowledge/Concepts/contacts.md

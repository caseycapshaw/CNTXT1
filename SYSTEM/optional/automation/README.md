...
> working notes; never triage them into `CONTENT/raw/`. The daily note **queries** your
...
4. On success, append one line to `SYSTEM/log.md`. On API-unreachable-after-retries, write a **stub** with a one-click retry instead of skipping the day.

...
`concepts/`, `Initiatives/`, `meta/`, `raw/`, `daily/`, `People/`, `Jobs/`, `attachments/`, and `Excalidraw/` (optional) are **structural folders — not inbox items**.
...
- Root inbox clean: only the four anchors + structural folders (`concepts/`, `Initiatives/`, `meta/`, `raw/`, `daily/`, `People/`, `Jobs/`, `attachments/`, `Excalidraw/`).

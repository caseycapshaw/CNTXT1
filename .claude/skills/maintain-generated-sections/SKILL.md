---
name: maintain-generated-sections
description: The standing convention for machine-maintained file sections — config above a marker, generated content below, fail loud, never hand-edit below the line. Use when any file a script rewrites, any new data feed, any 'always current' requirement.
metadata:
  title: Maintain Generated Sections
  type: rule
  domain: kb-meta

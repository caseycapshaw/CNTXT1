...
description: Pulls a generic schema/script/runbook/template improvement from the public CNTXT1 starter kit into this vault via git, leaving personal content untouched. Use when a framework improvement lands in the public CNTXT1 kit.
metadata:
  title: Pull Framework Updates from CNTXT1
  type: do
  domain: kb-meta

...
> **When:** a `CONTENT/` folder (Concepts, Initiatives, People, Agents, a
...
3. **Write the `.base` file** at `CONTENT/<Folder>/<Folder>-Dashboard.base`.
   ...
   existing `CONTENT/Concepts/Concepts-Dashboard.base`:
...
- `CONTENT/Concepts/Concepts-Dashboard.base` — the reference instance.

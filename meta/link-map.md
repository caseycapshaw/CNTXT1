...
_Generated by `meta/bin/build-link-map.sh`. Do not hand-edit — regenerate after adding/renaming a concept, person, or job._
...
| `[[Initiative TEMPLATE]]` | `concepts/Initiative TEMPLATE.md` |
